...
## Corpus Check
- 59 files · ~608,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 331 nodes · 660 edges · 22 communities (17 shown, 3 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea5db12c`
...
- campaign-Blue-investigatio-09b33-tainment-results-and-replay/error-context.md
- campaign-operation-selecti-b6de4--→-reconstruction-→-unlocks/error-context.md
...
Cohesion: 0.33
Nodes (11): commonDetections, discover(), external, file(), host(), identity(), link(), Machine (+3 more)
...
### Community 20 - "campaign-Blue-investigatio-09b33-tainment-results-and-replay/error-context.md"
Cohesion: 0.40
Nodes (4): Error details, Instructions, Test info, Test source

### Community 21 - "campaign-operation-selecti-b6de4--→-reconstruction-→-unlocks/error-context.md"
Cohesion: 0.40
Nodes (4): Error details, Instructions, Test info, Test source

## Knowledge Gaps
- **119 isolated node(s):** `geistSans`, `geistMono`, `metadata`, `apps`, `Props` (+114 more)
...
- **Why does `SimulationEngine` connect `SimulationEngine` to `index.ts`, `content.ts`?**
