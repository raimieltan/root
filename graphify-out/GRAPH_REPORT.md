...
## Corpus Check
- 71 files · ~634,369 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 520 nodes · 1004 edges · 33 communities (28 shown, 3 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7dc8b88`
...
Cohesion: 0.07
Nodes (33): BlueTeamPage(), formatWindow(), CareerPage(), completeExercise(), proficiencyLabel, Home(), MissionPanel(), NetworkMap() (+25 more)
...
Cohesion: 0.17
Nodes (16): ReplayPageProps, emptySnapshot, formatElapsed(), ReplayClient(), ReplayPayload, KeyDecision, ReplayEvent, ReplayLens (+8 more)
...
### Community 32 - "Realistic Interaction Layer — Progress Checkpoint"
Cohesion: 0.11
Nodes (17): 1. Structured tool intents and terminal context, 2. Declarative Glasshouse application route, 3. Unix investigation commands, 4. Prompted SSH and PostgreSQL authentication, 5. Scenario content and migrations, 6. First-class credentials and Credentials application, Deliberately still present, Delivered vertical slices (+9 more)

## Knowledge Gaps
- **257 isolated node(s):** `proficiencyLabel`, `geistSans`, `geistMono`, `metadata`, `apps` (+252 more)
